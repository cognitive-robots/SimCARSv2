...
class PLGScene : public virtual AFileBasedScene<PLGScene>, public virtual ADrivingScene
{
...
protected:
    ...
    void load_virt(std::ifstream &input_filestream,
                   structures::ISet<std::string>* agent_names) override;

public:
    ~PLGScene();

    static PLGScene* construct_from(IDrivingScene *driving_scene);
