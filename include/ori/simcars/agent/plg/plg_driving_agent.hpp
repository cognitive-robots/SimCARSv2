...
class PLGDrivingAgent : public virtual ADrivingAgent
{
    std::string name;
...
public:
    PLGDrivingAgent(IDrivingScene const *driving_scene, size_t tracks_start_index,
                    size_t tracks_end_index, rapidcsv::Document const &tracks_csv_document);
