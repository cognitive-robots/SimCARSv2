...
{
public:
    virtual FP_DATA_TYPE calc_reward(PedOutcome const *outcome, PedTask const *task,
                                     PedRewardParameters const *parameters) const = 0;
    virtual PedRewards calc_rewards(PedOutcome const *outcome, PedTask const *task,
                                    PedRewardParameters const *parameters) const = 0;
};
