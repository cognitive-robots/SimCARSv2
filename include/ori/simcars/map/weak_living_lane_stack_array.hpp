...
class WeakLivingLaneStackArray : public virtual AWeakLaneArray<T_id>, public virtual structures::stl::STLStackArray<std::weak_ptr<const ILane<T_id>>>
{
public:
    ...
    {
        return std::shared_ptr<const IWeakLaneArray<T_id>>(this);
    }
};
