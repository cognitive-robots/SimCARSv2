...
class AWeakLaneArray : public virtual IWeakLaneArray<T_id>, public virtual structures::AArray<std::weak_ptr<const ILane<T_id>>>, public ASoul<IWeakLaneArray<T_id>>
{
};
