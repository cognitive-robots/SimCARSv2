...
CalcMultiPedActionOutcomeRewardVariable::CalcMultiPedActionOutcomeRewardVariable(
...
bool CalcMultiPedActionOutcomeRewardVariable::get_value(RewardPedOutcomeActionTuples &val) const
{
...
bool CalcMultiPedActionOutcomeRewardVariable::set_value(RewardPedOutcomeActionTuples const &val)
{
