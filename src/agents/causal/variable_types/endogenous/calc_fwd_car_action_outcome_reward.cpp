...
CalcFWDCarActionOutcomeReward::CalcFWDCarActionOutcomeReward(
...
structures::stl::STLStackArray<RewardFWDCarActionPair> CalcFWDCarActionOutcomeReward::get_value() const
{
