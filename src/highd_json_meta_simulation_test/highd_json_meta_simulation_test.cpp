...
int main(int argc, char *argv[])
{
    ...
    temporal::Time simulation_start_time =
            temporal::Time(temporal::Duration(40 *
                                              uint32_t(0.75 * latest_initial_frame +
                                              0.25 * earliest_final_frame)));
    temporal::Time simulation_end_time =
            temporal::Time(temporal::Duration(40 *
                                              uint32_t(0.25 * latest_initial_frame +
                                              0.75 * earliest_final_frame)));
